...
def main():
    ...
    parser.add_argument('-src', '--source', default="pan_1d_daisy_TRUE_emb0823.slim", type=str,
                        help=r"SLiM file to be run. Default 'pan_1d_daisy_TRUE_emb0823.slim'")
    ...
    parser.add_argument('-emb_res', '--EMBRYO_RESISTANCE_RATE', default=0.1, type=float,
    ...
    if args_dict.pop("print_header", None):
        print("result,size_all,generation,Drop_Size,Embryo_Resistance_Rate,slice,drive1_freq,drive2_freq,drive3_freq,pop_size,drop_proportion")
