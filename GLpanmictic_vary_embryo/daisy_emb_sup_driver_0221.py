...
def main():
    ...
    parser.add_argument('-src', '--source', default="daisy_pan_Jialiang_multigrna_0823.slim", type=str,
                        help=r"SLiM file to be run. Default 'daisy_pan_Jialiang_multigrna_0823.slim'")
...
##add columns
    ...
    if args_dict.pop("print_header", None):
        print("result,generation,pop_size,drive1_freq,drive2_freq,drive3_freq,genetic_load,drop_size,EMBRYO_RESISTANCE_RATE,Genetic_Load"*50)
