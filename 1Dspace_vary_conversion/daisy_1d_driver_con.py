...
def main():
    ...
    parser.add_argument('-src', '--source', default="pan_1d_daisy_TRUE_conversion_0823.slim", type=str,
                        help=r"SLiM file to be run. Default 'pan_1d_daisy_TRUE_conversion_0823.slim'")
    ...
    parser.add_argument('-drop_radius', '--DROP_RADIUS', default=0.15, type=float,
                        help='The drop size of daisy drive . Default 0.15.')

    parser.add_argument('-conversion_rate', '--DRIVE_CONVERSION', default=0.9, type=float,
                        help='The conversion rate of daisy drive . Default 0.9.')
    ...
    if args_dict.pop("print_header", None):
        print("result,size_all,generation,Drop_Size,Conversion_Rate,slice,drive1_freq,drive2_freq,drive3_freq,pop_size,drop_proportion")
