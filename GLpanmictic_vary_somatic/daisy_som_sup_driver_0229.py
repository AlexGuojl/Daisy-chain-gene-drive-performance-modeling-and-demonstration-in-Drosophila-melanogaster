...
def main():
    ...
    parser.add_argument('-src', '--source', default="daisy_pan_Jialiang_multigrna_0823_som.slim", type=str,
                        help=r"SLiM file to be run. Default 'daisy_pan_Jialiang_multigrna_0823_som.slim'")
    ...
    parser.add_argument('-drop_size', '--DROP_SIZE', default=0.8, type=float,
                        help='The drop size of daisy drive . Default 0.8.')
  
    parser.add_argument('-conversion_rate', '--DRIVE_CONVERSION', default=0.9, type=float,
                        help='The extra female fitness of daisy drive . Default 0.9.')

    
    parser.add_argument('-somatic_mult_f', '--SOMATIC_FITNESS_MUTLIPLIER_F', default=0.9, type=float,
                        help='The extra female fitness of daisy drive . Default 0.9.')

    parser.add_argument('-embryo_resistance_rate', '--EMBRYO_RESISTANCE_RATE', default=0.1, type=float,
                      help='The embryo resistance rate of daisy drive . Default 0.1.')
...
##add columns
    ...
    if args_dict.pop("print_header", None):
        print("result,generation,pop_size,drive1_freq,drive2_freq,drive3_freq,genetic_load,drop_size,Somatic_Fitness_F,Genetic_Load"*50)
