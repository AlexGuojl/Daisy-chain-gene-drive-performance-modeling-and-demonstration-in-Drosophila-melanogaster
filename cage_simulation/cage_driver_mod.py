...
def main():
    ...
    parser.add_argument('-src', '--source', default="cage_model_mod_5.0.slim", type=str,
                        help=r"SLiM file to be run. Default 'cage_model_mod_5.0.slim'")
...
##add columns
    ...
    if args_dict.pop("print_header", None):
        print("result,generation,pop_size,drive1_freq,drive2_freq,drive3_freq,genetic_load,drop_size,Cas_Conversion_Rate,Cargo_Conversion_Rate"*50)
